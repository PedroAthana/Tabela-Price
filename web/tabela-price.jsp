<%-- 
    ...
    Created on : 29/03/2021, 13:49:44
    Author     : Monica
--%>
    ...
    <body>    
        ...
        <div class="text-left" style="margin-left: 50px; margin-right: 50px">
            ...
            <%@include file="WEB-INF/jspf/cabecalho.jspf" %>
                <form>
                    <h6 align="center">Valor da Parcela<br><input type="number" name="n1" placeholder="em R$"></h6>
                    <h6 align="center">Juros<br><input type="number" name="n2" placeholder="em %"></h6>
                    <h6 align="center">Quantidade de Prestações<br><input type="number" name="n3"></h6>
                    <div align="center"><input type="submit" value="Calcular"</div>
                </form>
                <%if (request.getParameter("n1") == null || request.getParameter("n2") == null
                            || request.getParameter("n3") == null) {%>
                <%} else if (erro != null) {%>
